 ...
 */
class DMItemDetailFragment : DMBaseFragment(), View.OnClickListener {
    ...
    private fun initViews(dmMenuDetails: ArrayList<DMMenuDetail>) {
        ...
        detailView!!.findViewById<View>(R.id.menu_item_image).setOnClickListener { DMUtils.showImageDialog(activity, dmSubCategory!!.itemImage) }
    }
