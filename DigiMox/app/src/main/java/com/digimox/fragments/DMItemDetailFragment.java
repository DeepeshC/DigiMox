 ...
 */
public class DMItemDetailFragment extends DMBaseFragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        detailView = inflater.inflate(R.layout.fragment_item_details, container, false);
        setOnClickListener();
        return detailView;
    }
    ...
    private void initViews(ArrayList<DMMenuDetail> dmMenuDetails) {
        ...
        DMMenuDetail dmMenuDetail = dmMenuDetails.get(0);
        ...
        detailView.findViewById(R.id.menu_item_image).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                DMUtils.showImageDialog(getActivity(), dmSubCategory.getItemImage());
            }
        });
    }
