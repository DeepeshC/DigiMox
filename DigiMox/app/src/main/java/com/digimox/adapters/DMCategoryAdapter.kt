 ...
 */
class DMCategoryAdapter(private val context: Context, private val dmMainCategoryFragment: DMMainCategoryFragment, private val dmMainCategories: ArrayList<DMMainCategory>) : RecyclerView.Adapter<DMCategoryAdapter.ViewHolder>() {
